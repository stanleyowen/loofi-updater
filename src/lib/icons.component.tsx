...
export function PreferencesOutline() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 15 15">
            <g fill="none">
                <path
                    d="M15 3.5H6.5m0 0a2 2 0 1 0-4 0m4 0a2 2 0 1 1-4 0m0 0H0m15 8h-2.5m0 0a2 2 0 1 0-4 0m4 0a2 2 0 1 1-4 0m0 0H0"
                    stroke="currentColor"
                ></path>
            </g>
        </svg>
...
export function PreferencesSolid() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 15 15">
            <g fill="none">
                <path
                    d="M4.5 1a2.5 2.5 0 0 0-2.45 2H0v1h2.05a2.5 2.5 0 0 0 4.9 0H15V3H6.95A2.5 2.5 0 0 0 4.5 1z"
                    fill="currentColor"
                ></path>
                <path
                    d="M10.5 9a2.5 2.5 0 0 0-2.45 2H0v1h8.05a2.5 2.5 0 0 0 4.9 0H15v-1h-2.05a2.5 2.5 0 0 0-2.45-2z"
                    fill="currentColor"
                ></path>
            </g>
        </svg>
...
export function AboutSolid() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 24 24">
            <path
                d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10s-4.477 10-10 10zm-1-11v6h2v-6h-2zm0-4v2h2V7h-2z"
                fill="currentColor"
            ></path>
        </svg>
    );
...
export function ChevronLeft() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 16 16">
            <path
                fill="currentColor"
                d="M2.9 8l8-8l2.2 2.1L7.2 8l5.9 5.9l-2.2 2.1z"
            ></path>
        </svg>
    );
}
export function ChevronRight() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 16 16">
            <path
                fill="currentColor"
                d="M13.1 8l-8 8l-2.2-2.1L8.8 8L2.9 2.1L5.1 0z"
            ></path>
        </svg>
    );
}
...
export function PrivacyPolicy() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 48 48">
            <path
                d="M6 8.256L24.009 3L42 8.256v10.778A26.316 26.316 0 0 1 24.003 44h0A26.32 26.32 0 0 1 6 19.029V8.256z"
                stroke="currentColor"
                strokeWidth="4"
...
export function Themes() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 16 16">
            <path
                fillRule="evenodd"
                d="M11.134 1.535C9.722 2.562 8.16 4.057 6.889 5.312C5.8 6.387 5.041 7.401 4.575 8.294a3.745 3.745 0 0 0-3.227 1.054c-.43.431-.69 1.066-.86 1.657a11.982 11.982 0 0 0-.358 1.914A21.263 21.263 0 0 0 0 15.203v.054l.75-.007l-.007.75h.054a14.404 14.404 0 0 0 .654-.012a21.243 21.243 0 0 0 1.63-.118c.62-.07 1.3-.18 1.914-.357c.592-.17 1.226-.43 1.657-.861a3.745 3.745 0 0 0 1.055-3.217c.908-.461 1.942-1.216 3.04-2.3c1.279-1.262 2.764-2.825 3.775-4.249c.501-.706.923-1.428 1.125-2.096c.2-.659.235-1.469-.368-2.07c-.606-.607-1.42-.55-2.069-.34c-.66.213-1.376.646-2.076 1.155zm-3.95 8.48a3.76 3.76 0 0 0-1.19-1.192a9.758 9.758 0 0 1 1.161-1.607l1.658 1.658a9.853 9.853 0 0 1-1.63 1.142zM.742 16l.007-.75l-.75.008A.75.75 0 0 0 .743 16zM12.016 2.749c-1.224.89-2.605 2.189-3.822 3.384l1.718 1.718c1.21-1.205 2.51-2.597 3.387-3.833c.47-.662.78-1.227.912-1.662c.134-.444.032-.551.009-.575h-.001V1.78c-.014-.014-.112-.113-.548.027c-.432.14-.995.462-1.655.942zM1.62 13.089a19.56 19.56 0 0 0-.104 1.395a19.55 19.55 0 0 0 1.396-.104a10.528 10.528 0 0 0 1.668-.309c.526-.151.856-.325 1.011-.48a2.25 2.25 0 0 0-3.182-3.182c-.155.155-.329.485-.48 1.01a10.515 10.515 0 0 0-.309 1.67z"
                fill="currentColor"
            ></path>
        </svg>
    );
...
export function ThemesApp() {
    return (
        <svg width="3em" height="3em" viewBox="0 0 256 256" className="m-auto">
            <path
                d="M216 44.006H40a12.014 12.014 0 0 0-12 12v144a12.014 12.014 0 0 0 12 12h176a12.014 12.014 0 0 0 12-12v-144a12.014 12.014 0 0 0-12-12zm4 156a4.005 4.005 0 0 1-4 4H40a4.005 4.005 0 0 1-4-4v-144a4.005 4.005 0 0 1 4-4h176a4.005 4.005 0 0 1 4 4zm-144-116a8 8 0 1 1-8-8a8 8 0 0 1 8 8zm40 0a8 8 0 1 1-8-8a8 8 0 0 1 8 8z"
                fill="currentColor"
            ></path>
        </svg>
    );
...
export function Windows() {
    return (
        <svg width="6em" height="6em" viewBox="0 0 48.745 48.747">
            <g fill="currentColor">
                <path d="M0 0H23.105V23.105H0z"></path>
                <path d="M25.64 0H48.745000000000005V23.105H25.64z"></path>
                <path d="M0 25.642H23.105V48.747H0z"></path>
                <path d="M25.64 25.642H48.745000000000005V48.747H25.64z"></path>
            </g>
        </svg>
    );
    // return <svg width="6em" height="6em" viewBox="0 0 1664 1664"><path d="M682 878v651L0 1435V878h682zm0-743v659H0V229zm982 743v786l-907-125V878h907zm0-878v794H757V125z" fill="currentColor"></path></svg>
}
export function MacOS() {
    return (
        <svg width="6em" height="6em" viewBox="0 0 20 20">
            <path
                fill="currentColor"
                fillRule="evenodd"
...
export function SaveLocation() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 1115 1462">
            <path
                d="M0 788q0 151 75.5 279.5t204 203T558 1345q153 0 281-74t202-202t74-281q0-38-25.5-65t-62.5-27t-64 27t-27 65q0 157-110.5 267.5T558 1166q-155 0-264-110.5T185 788q0-136 84.5-246.5T466 424l-41 39q-26 28-26 62q0 36 26 64q58 56 129 0l196-194q26-20 26-66q0-41-26-61L554 70q-28-26-61-26q-40 0-67 26.5T399 135q0 39 26 65l41 38q-200 35-333 191.5T0 788z"
                fill="currentColor"
            ></path>
        </svg>
    );
...
export function AutoPlay() {
    return (
        <svg width="1em" height="1em" viewBox="0 0 24 24">
            <path
                d="M4 2h10v2H4v10H2V4c0-1.11.89-2 2-2m4 4h10v2H8v10H6V8c0-1.11.89-2 2-2m4 4h8c1.11 0 2 .89 2 2v8c0 1.11-.89 2-2 2h-8c-1.11 0-2-.89-2-2v-8c0-1.11.89-2 2-2m2 2v8l6-4l-6-4z"
                fill="currentColor"
            ></path>
        </svg>
    );
...
export function Contributors() {
    return (
        <svg width="1.2em" height="1.2em" viewBox="0 0 20 20">
            <g fill="none">
                <path
                    d="M8.75 3.75a2.75 2.75 0 1 0-5.5 0a2.75 2.75 0 0 0 5.5 0zm-4.5 0a1.75 1.75 0 1 1 3.5 0a1.75 1.75 0 0 1-3.5 0z"
                    fill="currentColor"
                ></path>
                <path
                    d="M2.5 7.5h4.183c-.164.31-.286.646-.358 1H2.5A.5.5 0 0 0 2 9v.5c0 1.26 1.099 2.614 3.096 2.93c-.322.22-.59.513-.781.854C2.205 12.713 1 11.087 1 9.5V9a1.5 1.5 0 0 1 1.5-1.5z"
                    fill="currentColor"
                ></path>
                <path
                    d="M7.879 7.5c.504-.61 1.267-1 2.121-1a2.744 2.744 0 0 1 2.646 2a2.753 2.753 0 0 1-3.893 3.202A2.75 2.75 0 0 1 7.88 7.5zm.54 1a1.75 1.75 0 1 0 3.164 1.5a1.75 1.75 0 0 0-3.165-1.5z"
                    fill="currentColor"
                ></path>
                <path
                    d="M15.685 13.284a2.513 2.513 0 0 0-.781-.853C16.9 12.114 18 10.759 18 9.5V9a.5.5 0 0 0-.5-.5h-3.825a3.726 3.726 0 0 0-.357-1H17.5A1.5 1.5 0 0 1 19 9v.5c0 1.587-1.206 3.212-3.315 3.784z"
                    fill="currentColor"
                ></path>
                <path
                    d="M14.487 13.37c-.264-.23-.609-.37-.987-.37h-7A1.496 1.496 0 0 0 5 14.5v.5c0 1.971 1.86 4 5 4c3.14 0 5-2.029 5-4v-.5c0-.45-.198-.854-.513-1.13zM6 14.5a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 .5.5v.5c0 1.438-1.432 3-4 3s-4-1.562-4-3v-.5z"
                    fill="currentColor"
                ></path>
                <path
                    d="M14 1a2.75 2.75 0 1 1 0 5.5A2.75 2.75 0 0 1 14 1zm0 1a1.75 1.75 0 1 0 0 3.5A1.75 1.75 0 0 0 14 2z"
                    fill="currentColor"
                ></path>
            </g>
        </svg>
...
export function MusicOutline() {
    return (
        <svg width="1.2em" height="1.2em" viewBox="0 0 256 256">
            <path
                d="M212.923 25.694a7.999 7.999 0 0 0-6.863-1.455l-128 32A8 8 0 0 0 72 64v110.083A35.99 35.99 0 1 0 88 204v-85.754l112-28v51.837A35.99 35.99 0 1 0 216 172V32a7.999 7.999 0 0 0-3.077-6.306zM52 224a20 20 0 1 1 20-20a20.022 20.022 0 0 1-20 20zm36-122.246V70.246l112-28v31.508zM180 192a20 20 0 1 1 20-20a20.022 20.022 0 0 1-20 20z"
                fill="currentColor"
            ></path>
        </svg>
    );
}
export function MusicSolid() {
    return (
        <svg width="1.2em" height="1.2em" viewBox="0 0 256 256">
            <path
                d="M215.994 31.996v140a36.062 36.062 0 1 1-16-29.904V82.238l-112 28v93.758a36.062 36.062 0 1 1-16-29.904V63.996a7.997 7.997 0 0 1 6.063-7.758l128-32a7.896 7.896 0 0 1 6.859 1.453a8.015 8.015 0 0 1 3.078 6.305z"
                fill="currentColor"
            ></path>
        </svg>
    );
